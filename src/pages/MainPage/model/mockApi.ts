...
export const themes = [
  ...
  { id: 5, label: 'Музыка', from: 2015, to: 2018 },
  { id: 6, label: 'Спорт', from: 1999, to: 2024 },
]
...
export const events = [
  ...
  // Музыка (themeId: 5)
  {
    id: 17,
    themeId: 5,
    title: 'Концерт популярного артиста',
    description: 'Выступление знаменитого музыканта на большой сцене.',
    date: '2015-08-01',
  },
  {
    id: 18,
    ...
    description: 'Фестиваль, объединяющий поклонников различных музыкальных жанров.',
    date: '2016-04-18',
  },
  {
    id: 19,
    themeId: 5,
    title: 'Премьера альбома',
    description: 'Релиз нового альбома с грандиозной презентацией.',
    date: '2017-09-09',
  },
  {
    id: 20,
    themeId: 5,
    title: 'Выступление в прямом эфире',
    description: 'Прямой эфир концерта с участием популярных исполнителей.',
    date: '2018-06-15',
  },
  // Спорт (themeId: 6)
  {
    ...
    description: 'Кульминационное событие спортивного сезона.',
    date: '1999-10-30',
  },
  {
    id: 22,
    themeId: 6,
    title: 'Марафон города',
    description: 'Городской марафон с участием сотен спортсменов.',
    date: '2016-03-12',
  },
  {
    id: 23,
    themeId: 6,
    title: 'Дебют спортсмена',
    description: 'Первое выступление нового таланта в мире спорта.',
    date: '2017-07-07',
  },
  {
    id: 24,
    ...
    description: 'Торжественное открытие современного спортивного комплекса.',
    date: '2024-01-20',
  },
]
